/**
 *  Reference: https://github.com/mourner/icomesh/blob/master/index.js
 */



/*
    icomesh(order) -> {indices: Uint16Array, position: Float32Array, normal: Float32Array}

    return a sphere (radius = 1, center = (0, 0, 0)) with indices, position and normal vectors.
*/
function icomesh(order = 3) {
